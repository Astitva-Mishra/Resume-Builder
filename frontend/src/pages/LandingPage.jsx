    ...
    <div className={landingPageStyles.container}>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <span className={landingPageStyles.footerText}>
            Made By Astitva Mishra, Arpit Kumar and Aryan Malik
          </span>
        </div>
      </footer>

      {/* MODAL FOR LOGIN AND SIGNUP */}
      {/*Koi to error hai yaha pe jiski wajah se i am getting Modal written at the bottom of the footer page usko check karna hai */}
      <Modal
