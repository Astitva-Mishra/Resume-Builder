...
const EditResume = () => {
  ...
  //Take back to the previous page or to take back to dashboard
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  //Sdding new item ie Information
  ...
  //fertching the resume details by id or you can say using the backend url
  ...
  //It will help in choosing the preview as well as in downloading the resume also saves the resume as image
  ...
  //this will help in updating the resume and put will help in updation on bbackend
  ...
  const downloadPDF = async () => {
    ...
    try {
      await html2pdf()
        ...
        .from(element)
        .save(); //save the resume here and can we downloaded when needed
  ...
  //so all this function will be used for the edit resumes
  useEffect(() => {
    if (resumeId) {
